...
|---|---|---|---|
| java `5189da7` | implicit-contract-reentry sink table (existed for `String.format`/`append`/`println`) — logging facades were simply absent from it | the field case, 18.7k fns: **8939 -> 8939 effectful, 0 changed** | 436 |
