...
**Version 0.36** — all code engines declare `0.36`; the floor is conformance-pinned. How versions
...
```json
{
  "candor":    { "version": "<engine build id>", "toolchain": "<channel>", "spec":    "0.36" },
...
```json
{ "candor": { "version": "…", "toolchain": "…", "spec": "0.36" },
