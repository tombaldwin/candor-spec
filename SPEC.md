...
**Version 0.38** — all code engines declare `0.38`; the floor is conformance-pinned. How versions
...
```json
{
  "candor":    { "version": "<engine build id>", "toolchain": "<channel>", "spec":    "0.38" },
...
```json
{ "candor": { "version": "…", "toolchain": "…", "spec": "0.38" },
