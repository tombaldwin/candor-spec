...
**Version 0.37** — all code engines declare `0.37`; the floor is conformance-pinned. How versions
...
```json
{
  "candor":    { "version": "<engine build id>", "toolchain": "<channel>", "spec":    "0.37" },
...
```json
{ "candor": { "version": "…", "toolchain": "…", "spec": "0.37" },
