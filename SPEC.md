...
**Version 0.33** — all code engines declare `0.33`; the floor is conformance-pinned. How versions
...
```json
{
  "candor":    { "version": "<engine build id>", "toolchain": "<channel>", "spec":    "0.33" },
...
```json
{ "candor": { "version": "…", "toolchain": "…", "spec": "0.33" },
