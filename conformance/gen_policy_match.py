...
def _rust_tree(d, case):
    ...
    gd.write_rust_tree(d, "polmatch", "gen_policy_match.py", body)
...
def _java_tree(d, case):
    gd.write_java_tree(d, "gen_policy_match.py", case["java"].format(),
                       pkg=java_pkg(case), src=java_src(d, case))
...
def _ts_tree(d, case):
    gd.write_ts_tree(d, "polmatch", "gen_policy_match.py", case["ts"].format(),
                     sub=ts_dir(d, case))
